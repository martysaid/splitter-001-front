...
function ProfileForm({ user }: { user: User }) {
  const { form, onSubmit, isSubmitting, isDirty, error, success, clearMessages } =
    useProfileForm(user);
      ...
      <SectionWrapper className="w-full items-start !gap-6">
        ...
        <div className="flex w-full flex-col gap-4">
          <p className="text-left">
            A verification link has been sent to your new email address. Check your inbox and click
    ...
    <SectionWrapper className="w-full items-start !gap-6">
      ...
      <div className="flex w-full flex-col gap-4">
        <div className="flex justify-between">
          ...
          <span className="text-base capitalize md:text-xl">{user.role}</span>
        </div>
        <div className="flex justify-between">
